...
EstimateItemResponse estimateItemResponseFromJson(String str) => EstimateItemResponse.fromJson(json.decode(str));

String estimateItemResponseToJson(EstimateItemResponse data) => json.encode(data.toJson());
...
class EstimateItemResponse {
  ...
  factory EstimateItemResponse.fromJson(Map<String, dynamic> json) => EstimateItemResponse(
    count: json["count"],
    next: json["next"],
    previous: json["previous"],
    results: List<EstimateItem>.from(json["results"].map((x) => EstimateItem.fromJson(x))),
  );
