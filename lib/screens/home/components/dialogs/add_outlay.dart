...
class AddOutlayDialog extends StatefulWidget {
  ...
  final List<Manufacture> manufacturers;
  final List<OutlayItem> outlayItems;

  AddOutlayDialog({this.outlayCategory, this.manufacturers, this.outlayItems});
...
//                    contentPadding: EdgeInsets.fromLTRB(10.0, 30.0, 10.0, 20.0),
            ...
            Padding(
              padding: EdgeInsets.only(
                  ...
                  right: ScreenUtil().setWidth(24),
                  bottom: ScreenUtil().setHeight(24)),
              child: searchTextField3 = AutoCompleteTextField<String>(
                style: new TextStyle(color: Colors.black, fontSize: 16.0),
                decoration: new InputDecoration(
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(20),
...
//                    contentPadding: EdgeInsets.fromLTRB(10.0, 30.0, 10.0, 20.0),
                ...
                itemSubmitted: (item) {
                  setState(
                      () => searchTextField3.textField.controller.text = item);
                },
                clearOnSubmit: false,
                key: Gkey3,
                suggestions: [
